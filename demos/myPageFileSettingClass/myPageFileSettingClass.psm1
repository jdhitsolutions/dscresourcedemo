...
#turning on Verbose can help with troubleshooting during Pester tests
...
Class CustomPageFile2 {
    ...
    [bool] Test() {   
        ...
        Write-Verbose "[CLASS] Querying class Win32_PagefileSetting"    

        $pfs = Get-CimInstance -Classname Win32_PageFileSetting 
        
        Write-Verbose "[CLASS] CimInstance result:"
        Write-Verbose  "$($pfs | out-string)"
        Write-Verbose "[CLASS] Comparing intial size of $($this.Initialsize)"
        Write-Verbose "[CLASS] Comparing maximum size of $($this.Maximumsize)"
